                ...
                <div class="container-fluid">
                    <div class="header-left">
                        ...
                        <a href="{{url('/')}}" class="logo">
                            <img src="{{asset('frontend/assets')}}/images/icons/menu_logo.jpg" alt="Logo">
                        </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banner banner-big banner-overlay">
                                <a href="#">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/banners/banner-1.jpg" alt="Banner">
                                </a>
                        ...
                        <div class="col-lg-6">
                            <div class="banner banner-big banner-overlay">
                                <a href="#">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/banners/banner-2.jpg" alt="Banner">
                                </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-lg-4">
                            <div class="banner banner-overlay text-white">
                                <a href="#">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/banners/banner-3.jpg" alt="Banner">
                                </a>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="banner banner-overlay color-grey">
                                <a href="#">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/banners/banner-4.jpg" alt="Banner">
                                </a>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="banner banner-overlay text-white">
                                <a href="#">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/banners/banner-5.jpg" alt="Banner">
                                </a>
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-1-1.jpg" alt="Product image" class="product-image">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-1-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-2-1.jpg" alt="Product image" class="product-image">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-2-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="product.html">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-3-1.jpg" alt="Product image" class="product-image">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-3-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-4-1.jpg" alt="Product image" class="product-image">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-4-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-5-1.jpg" alt="Product image" class="product-image">
                                            <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-5-2.jpg" alt="Product image" class="product-image-hover">
                                        </a>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-6-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-6-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-7-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-7-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-8-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-8-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-top">Top</span>
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-9-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-9-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-10-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-10-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-circle label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-11-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-11-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-12-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-12-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-13-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-13-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-14-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-14-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3 col-xl-5col">
                                    <div class="product product-7 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-15-1.jpg" alt="Product image" class="product-image">
                                                <img src="{{asset('frontend/assets')}}/images/demos/demo-7/products/product-15-2.jpg" alt="Product image" class="product-image-hover">
                                            </a>
                    ...
                    <div class="owl-carousel owl-simple mb-2" data-toggle="owl" 
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/blog/post-1.jpg" alt="image desc">
                                </a>
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/blog/post-2.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/blog/post-3.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{{asset('frontend/assets')}}/images/demos/demo-7/blog/post-4.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
