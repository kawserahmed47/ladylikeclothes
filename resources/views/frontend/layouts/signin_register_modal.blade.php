                    ...
                    <div class="form-tab">
                        ...
                        <div class="tab-content" id="tab-content-5">
                            <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                ...
                                <form id="customerLoginForm" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " placeholder="Please enter your email or mobile number" id="singin-email" name="email_or_mobile" required>
                                    </div><!-- End .form-group -->
                            ...
                            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                ...
                                <form id="customerRegisterForm" method="POST">
                                    @csrf

                                    <div class="form-group">
                                        <label for="email-info">Your email address or mobile number *</label>
                                        <input type="text" class="form-control" id="email-info" name="email_or_mobile" required>
                                    </div><!-- End .form-group -->
