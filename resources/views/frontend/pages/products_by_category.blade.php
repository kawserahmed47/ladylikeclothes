...
<div class="container">
    <div class="page-header page-header-big text-center" style="background-image: url('{{asset('frontend/assets')}}/images/contact-header-bg.jpg')">
        <h1 class="page-title text-white">Category<span class="text-white">Tagnail Sharee</span></h1>
    </div><!-- End .page-header -->
</div><!-- End .container -->
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{asset('frontend/assets')}}/images/products/product-1.jpg" alt="Product image" class="product-image">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{asset('frontend/assets')}}/images/products/product-3.jpg" alt="Product image" class="product-image">
                            </a>
