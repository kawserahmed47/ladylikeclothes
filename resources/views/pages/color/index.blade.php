                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 text-right">
                                        <a href="{{route('productColor.create')}}" class="btn btn-sm btn-primary">Add new</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            @if ($productColors)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ date('Y-m-d h:i a ', strtotime( $productColor->updated_at))}}

                                                    </td>
                                                    <td class="td-actions text-right">
                                                        <a rel="tooltip" class="btn btn-success btn-link" href="{{route('productColor.edit', $productColor->id)}}"
                                                            data-original-title="" title="Edit">
                                                            <i class="material-icons">edit</i>
                                                            <div class="ripple-container"></div>
                                                        </a><br>

                                                        <a rel="tooltip" class="btn btn-dark btn-link" href="{{route('productColor.show', $productColor->id)}}"
                                                        ...
                                                        <form method="POST"  action="{{route('productColor.destroy', $productColor->id)}}">
                                                            @csrf
                                                            @method('delete')
