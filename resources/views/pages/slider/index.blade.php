                ...
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        ...
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-slider">{{ __('Slider information') }}</p>
                        </div>
                                            ...
                                            @if ($sliders)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($slider->image)
                                                            <img src="{{asset($slider->image)}}" class="img-thumbnail previewImg" style="height:100px; width:100px" alt="previewImage">
                                                        @else
                                                    ...
                                                    <td>
                                                        {{ date('Y-m-d h:i a ', strtotime( $slider->updated_at))}}
    
                                                    </td>
                                                    <td class="td-actions text-right">
                                                        <a rel="tooltip" class="btn btn-success btn-link" href="{{route('slider.edit', $slider->id)}}"
                                                            data-original-title="" title="Edit">
                                                            <i class="material-icons">edit</i>
                                                            <div class="ripple-container"></div>
                                                        </a><br>
    
                                                        <a rel="tooltip" class="btn btn-dark btn-link" href="{{route('slider.show', $slider->id)}}"
